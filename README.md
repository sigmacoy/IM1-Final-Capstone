...
3. When a medicine is dispensed, the system shall automatically deduct the dispensed
quantity from the available stock of that medicine.
...
5. Medicines shall only be dispensed to students who are registered in the Student table of the system.
...
8. Only Admin users shall be permitted to increase or update the stock quantity of
medicines when new supplies are received.

9. A student shall not be allowed to receive more than two dispensations of the same
medicine within a seven-day period.

10. The system shall permanently record all dispensing transactions, including the
